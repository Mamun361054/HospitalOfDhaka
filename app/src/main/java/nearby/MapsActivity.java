...
import com.application.dorbesh.hospitalofdhaka.NearBy;
import com.application.dorbesh.hospitalofdhaka.NearByAdapter;
import com.application.dorbesh.hospitalofdhaka.R;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout = (LinearLayout) findViewById(R.id.nearbylist);
        btnDoctor = (Button) findViewById(R.id.btnDoctors);
